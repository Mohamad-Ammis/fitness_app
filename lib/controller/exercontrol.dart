...
class Exercontroller extends GetxController {
  ...
  Future getexer(String id, String? level) async {
    ...
    exercise = [];
    all_exer = [];
    final String url = level == null
        ? '${Constans.mainbaseUrl}category'
        : '${Constans.mainbaseUrl}trainer/exercise/gender';
    try {
  ...
  Future getexrciserandom(String id) async {
    ...
    all_exer = [];
    final String url =
        '${Constans.mainbaseUrl}trainer/exerciseType/getType/$id';
    try {
