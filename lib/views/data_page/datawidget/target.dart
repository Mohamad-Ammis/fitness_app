...
//2
  List goalsw = [
    {'name': 'Lose Weight', 'image': 'assets/images/lose.png', 'id': '1'},
    {'name': 'Build muscle', 'image': 'assets/images/mus.png', 'id': '2'},
    {'name': 'Keep fit', 'image': 'assets/images/fitt.png', 'id': '3'}
  ];
//1
  List goalsm = [
    {'name': 'Lose Weight', 'image': 'assets/images/lman.png', 'id': '1'},
    {'name': 'Build muscle', 'image': 'assets/images/musman.png', 'id': '2'},
    {'name': 'Keep fit', 'image': 'assets/images/fman.png', 'id': '3'}
  ];
              ...
              builder: (contr) => Column(
                ...
                children: [
                  Container(
                      ...
                      child: Question(
                        que: "What are your main goals ? ",
                        subt: "",
                      )),
                  ...(contr.man == 2 ? goalsw : goalsm)
                      .map(
                        (e) => InkWell(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                gradient: (contr.selectgoal == e['id'])
                                    ? LinearGradient(
                                        colors: [
