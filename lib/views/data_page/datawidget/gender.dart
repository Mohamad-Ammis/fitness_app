...
class Gender extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (ctx , cont) {
      controller.setwidth(MediaQuery.of(context).size.width , MediaQuery.of(context).size.height);
      return Container(
      ...
      child: Column(
        ...
        children: [
         Container(
          ...
          child:  Question( que: "What's your gender ? " , subt: "Let us know you better",)
         ),
            ...
            GetBuilder<Datacontroller>(
              builder:(contr)=> AnimatedPositioned(
                ...
                bottom: contr.bottomman,
                 ...
                 child: Image.asset("assets/images/mm.png" , fit: BoxFit.fitHeight,),
                 ) ,
                   )
                 ),
            ),
             GetBuilder<Datacontroller>(
               ...
               right:contr.rightwoman,
                bottom:contr.bottomwoman,
                 ...
                 width: cont.maxWidth*0.34,
                 child: Image.asset("assets/images/woman.png" , fit: BoxFit.fitHeight,),
                 ) ,
                   )
                 ),
             )
              ...
              SizedBox(
                ...
                child: Row(
                  ...
                  children: [
                      ...
                      builder:(contr)=> Radio(
                       ...
                       onChanged: (val){
                        contr.selectman(
                          ...
                          sizem:  MediaQuery.of(context).size.width*0.08 ,
                    ...
                    GetBuilder<Datacontroller>(
                      builder:(contr)=> AnimatedDefaultTextStyle(style: TextStyle(
                        color:contr.crman ,
                        fontSize:contr.sizeman ,
                        fontWeight:contr.weightman
                      ), duration:const Duration(seconds: 1), child:const Text("Male" )),
                    )
                    
                  ],
                ),
              ),
              SizedBox(width: cont.maxWidth*0.03,),
              SizedBox(
                ...
                child: Row(
                  ...
                  children: [
                    GetBuilder<Datacontroller>(
                      builder:(contr)=> Radio(value: 2, groupValue:contr.man, onChanged: (val){
                        contr.selectman(
                          m: val! ,
                          crw:controller.deepcolor ,
                          sizew:   MediaQuery.of(context).size.width*0.08 ,
                    ...
                    GetBuilder<Datacontroller>(
                      ...
                      ), duration:const Duration(seconds: 1), child:const Text("Female" )),
                    )
                  ],
                ),
              ),
