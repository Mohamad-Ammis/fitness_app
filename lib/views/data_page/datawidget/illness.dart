...
class Illness extends StatelessWidget {
  ...
  List ill = [
    {'name': 'Knee pain', 'image': 'assets/images/rrr.png', 'id': '1'},
    {'name': 'Heart diseases', 'image': 'assets/images/kk.png', 'id': '2'},
    {'name': 'shortness of breath', 'image': 'assets/images/tt.png', 'id': '3'}
  ];
              ...
              builder: (contr) => Column(
                ...
                children: [
                  Container(
                      ...
                      child: Question(
                        que: "Do you suffer from diseases  ? ",
                        subt: "",
                      )),
                  ...ill
                      .map(
