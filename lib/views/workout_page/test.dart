...
class Test extends StatelessWidget {
  List<int> muscle;
   Test({super.key , required this.muscle});
    ...
    return Container(
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                 const SizedBox(
                  ...
                  SizedBox(
                    height:400,
                    width: 400,
                    child: Image.asset("assets/images/testt.jpg" , fit: BoxFit.fitHeight,),
                  ),
                  //abs  1
                  Positioned(
                        top: 110 ,
            ...
            button(context , " Abs " , 10),
            button(context , " Chest " , 2),
            button(context , " Shoulder front " , 3),
  ...
  Widget hilight_area(  double h , double w  , bool special , double? tl ,double? tr , double? bl  ,double? br  , int area ) {
    return GetBuilder<Musclecontroller>(builder: (control)=> AnimatedContainer(
                    height: h,
                    width: w,
                    decoration:BoxDecoration(
                      border: Border.all(
                        width: 0.6 ,
                        color:muscle.contains(area) ? Colors.black:Colors.white.withOpacity(0)
                      ),
                      color:(control.areaa == area )?control.basic :muscle.contains(area) ? const Color.fromARGB(255, 38, 164, 170).withOpacity(0.4):Colors.white.withOpacity(0),
                      borderRadius: special==false? BorderRadius.circular(40):BorderRadius.only(
  ...
  Container button(BuildContext contex , String name , int area ) {
    return Container(
               height: MediaQuery.of(contex).size.height*0.11,
               ...
               child: ElevatedButton(onPressed: (){
                ...
                Timer(const Duration(milliseconds: 800), () { 
                   controller.setbasic(const Color.fromARGB(255, 38, 164, 170).withOpacity(0.4));
                });
               },
