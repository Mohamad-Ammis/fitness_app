...
class _FoodpartState extends State<Foodpart> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
        builder: (context, contr) => isloading == false
            ? ListView(
                children: [
                    ...
                    Container(
                      ...
                      child: Opacity(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(30),
                          child: Image.network(
                            "${Constans.mainbaseUrlimage}uploads/${meal.image!}",
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
                    ...
                    children: [
                      Container(
                        ...
                        margin: EdgeInsets.symmetric(
                            horizontal: contr.maxWidth * 0.05),
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(30),
                        ),
                        child: ClipRRect(
    ...
    return Container(
        ...
        child: ListView.builder(
            ...
            itemBuilder: (cont, ind) => Container(
                  ...
                  width: contr.maxWidth * 0.85,
                  margin:
                      EdgeInsets.symmetric(horizontal: contr.maxWidth * 0.05),
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(30),
                  ),
                  child: ClipRRect(
