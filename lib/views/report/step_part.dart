...
class _StepCalculateState extends State<StepCalculate> {
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              width: 290,
              child: const Text(
                "Please keep the page open while walking",
                style: TextStyle(
              ...
              child: Stack(
                children: [
                  KdGaugeView(
                    ...
                    minSpeed: 0,
                    maxSpeed: 1000,
                    speed: _steps == 'Step Count not available'
                        ? 0
                        : double.parse(_steps),
                    animate: true,
    ...
    return SizedBox(
      ...
      child: Row(
        children: [
          const Spacer(),
          dd("Cal Burned", "cal",
              _steps == 'Step Count not available' ? 0 : double.parse(_steps)),
          const Spacer(),
          Container(
  ...
  Positioned disgenstep() {
    return _steps != 'Step Count not available'
        ? Positioned(
            bottom: 50,
            left: 66,
            child: SizedBox(
        ...
        : const Positioned(
            ...
            child: SizedBox(
              ...
              width: 130,
              child: Text(
                "Sorry , Step Count not available",
                style: TextStyle(
                    fontSize: 19,
                    color: Colors.black,
                    fontFamily: Constans.fontFamily,
